...
export class TambahADMS extends Component {
  constructor(props) {
    super(props)
    this.state = {
      kacab: [],
  ...
  sendData() {
    {
      ...
      fetch('https://kilauindonesia.org/datakilau/api/tamadms', {
        method: 'POST',
        headers: {
  ...
  render() {
    return (
      <ScrollView style={{ backgroundColor: '#fff', height: '100%' }}>
        <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 16 }}>Tambah Admin Shelter</Text>
            ...
            <View style={style.kotakpicker}>
              <Picker
                ...
                <Picker.Item style={{ fontSize: 14, fontFamily: 'Poppins-Regular', fontWeight: 'bold' }}
                  label="Admin Shelter"
                  value="admin_shelter" key="admin_shelter" />
