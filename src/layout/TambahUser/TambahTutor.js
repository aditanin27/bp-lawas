import {
    ...
    Dimensions, Image, ScrollView, ToastAndroid, Modal
} from 'react-native'
...
export class TambahTutor extends Component {
    constructor(props) {
        super(props)
        this.state = {
            kacab: [],
    ...
    sendData() {
        {
            let simpandata = {
                ...
                id_wilbin: this.state.wb,
                id_shelter: this.state.sh,
            ...
            fetch('https://kilauindonesia.org/datakilau/api/tamtutor', {
                method: 'POST',
                headers: {
    ...
    render() {
        return (
            <ScrollView style={{ backgroundColor: '#fff', height: '100%' }}>
                <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 16, marginTop: 5 }}>Tambah Tutor</Text>
                <View style={{ marginTop: '10%' }}>
                    ...
                    <View style={style.form}>
                        ...
                        <TextInput
                            style={style.kotak3}
                            onChangeText={pendidikan => this.setState({ pendidikan })}
                    ...
                    <View style={style.form}>
                        ...
                        <TextInput
                            style={style.kotak3}
                            onChangeText={mapel => this.setState({ mapel })}
