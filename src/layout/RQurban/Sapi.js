      ...
      <ScrollView>
        <View>
          <View style={{ backgroundColor: '#0EBEDF' }}>
            <Text style={style.title}>Sapi</Text>
          </View>
          ...
          <View style={style.coltom}>
            <View>
              <View>
                ...
                <Text style={{ marginLeft: 10, fontWeight: 'bold' }}>Rp.27.500.000</Text>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          if (this.state.harga > 0) {
                            ...
                            this.setState({ harga: this.state.harga - 27500000 })
                          } else {
