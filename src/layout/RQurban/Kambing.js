...
class Kambing extends Component {
  constructor(props) {
    super(props)
    this.state = {
      ...
      <ScrollView>
        <View>
          <View style={{ backgroundColor: '#0EBEDF' }}>
            <Text style={style.title}>Kambing</Text>
          </View>
          ...
          <View style={style.coltom}>
            <View>
              <View>
                ...
                <Text style={{ marginLeft: 10, fontWeight: 'bold' }}>Rp.2.750.000</Text>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          if (this.state.harga > 0) {
                            ...
                            this.setState({ harga: this.state.harga - 2750000 })
                          } else {
